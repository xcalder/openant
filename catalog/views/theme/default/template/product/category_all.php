		...
		<div id="middle" class="<?php echo $class; ?>" role="main">
			...
			<div class="media">
			  <div class="media-left media-middle">
			    <a href="product/category.html?id=<?php echo $category['category_id'];?>">
			  ...
			  <div class="media-body">
			    <a href="product/category.html?id=<?php echo $category['category_id'];?>"><h5 class="media-heading"><?php echo $category['name'];?></h5></a>
			    ...
			    <div class="media">
				  <div class="media-left media-middle">
				    <a href="product/category.html?id=<?php echo $category['category_id'].'_'.$child['category_id'];?>">
				  ...
				  <div class="media-body">
				    <a href="product/category.html?id=<?php echo $category['category_id'].'_'.$child['category_id'];?>"><h6 class="media-heading"><?php echo $child['name'];?></h6></a>
