				...
				<div class="panel-body">
					<form action="<?php echo $added;?>" method="post" enctype="multipart/form-data" id="sale-product-list">
						...
						<tr>
							...
							<td class="col-md-2 col-sm-3 col-xs-3"><a target="_blank" href="<?php echo $this->config->item('catalog').'/product?product_id='.$product['product_id'];?>"><?php echo utf8_substr($product['name'], 0, 30);?></a></td>
