...
class Review_model extends CI_Model {
	...
	public function get_reviews($data=array())
	{
		...
		$this->db->select('product_description.name, product_review.product_id, product_review.review_id, product_review.status, product_review.author, product_review.text, product_review.date_added, product_review.date_modified, product.image');
