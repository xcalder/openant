...
class Layout_model extends CI_Model {
	...
	public function select_layout_ids(){
		...
		$this->db->or_where('route', 'admin/%');
		if($this->uri->segment(4) !== NULL){
			$this->db->or_where('route', 'admin/'.$this->uri->segment(1).'/%');
			$this->db->or_where('route', 'admin/'.$this->uri->segment(1).'/'.$this->uri->segment(2).'/%');
			$this->db->or_where('route', 'admin/'.$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/%');
			$this->db->or_where('route', 'admin/'.$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/'.$this->uri->segment(4));
			...
			$this->db->or_where('route', 'admin/home');
		}
