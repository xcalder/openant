		...
		<div class="col-md-12 middle-flat-left" role="main">
			<div class="panel panel-default" id="attribute-list">
				<div class="panel-heading row row-panel-heading bg-info">
					...
					<div class="navbar-right btn-group" role="group" aria-label="..." style="margin-right: 0">
						<a href="admin.php/product/attribute/add_attribute.html#edit-attribute" class="btn btn-default"><i class="glyphicon glyphicon-plus"></i></a>
						<button type="button" class="btn btn-default" onclick="confirm('确定吗？') ? $('#form-attribute').submit() : false;"><i class="glyphicon glyphicon-trash"></i></button>
					</div>
				</div>
				<!-- /widget-header -->
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-right"><a href="<?php echo site_url('product/attribute/edit_attribute?attribute_id='.$attribute['attribute_id'])?>#edit-attribute" class="btn btn-info"><i class="glyphicon glyphicon-edit"></i></a>
									</td>
								</tr>
								<?php endforeach;?>
								<?php endif;?>
			...
			<div class="panel panel-default" id="attribute-group">
				<div class="panel-heading row row-panel-heading bg-info">
					...
					<div class="navbar-right btn-group" role="group" aria-label="..." style="margin-right: 0">
						<a href="admin.php/product/attribute/add_attribute_group.html#edit-attribute-group" class="btn btn-default"><i class="glyphicon glyphicon-plus"></i></a>
						<button type="button" class="btn btn-default" onclick="confirm('确定吗') ? $('#form-attribute-group').submit() : false;"><i class="glyphicon glyphicon-trash"></i></button>
					</div>
				</div>
				<!-- /widget-header -->
				<div class="panel-body">
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-right"><a href="<?php echo site_url('product/attribute/edit_attribute_group?attribute_group_id='.$attribute_group['attribute_group_id'])?>#edit-attribute-group" class="btn btn-info"><i class="glyphicon glyphicon-edit"></i></a>
									</td>
								</tr>
								<?php endforeach;?>
								<?php endif;?>
