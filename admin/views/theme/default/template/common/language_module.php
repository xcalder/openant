<li class="dropdown">
	...
	<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img width="16px" height="11px" class="lazy" data-original="public/flags/<?php echo $language['image'];?>"><span class="visible-lg-inline"><?php echo $language['name']?></span></a>
	<?php endif;?>
	<?php endforeach;?>
	<?php else:?>
	<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img width="16px" height="11px" class="lazy" data-original="public/flags/<?php echo $language['image'];?>"><span class="visible-lg-inline"><?php echo $language['name'];?></span></a>
